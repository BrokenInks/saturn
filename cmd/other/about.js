...
module.exports = {
    ...
    execute(message, args, client) {
        ...
        const botEmbed = new Discord.MessageEmbed()
            .setColor('#0099ff')
            .setTitle('Invite')
            .setURL('https://discord.com/api/oauth2/authorize?client_id=872816105612247081&permissions=8&scope=bot')
            ...
            .addFields(
                { name: 'Имя: Saturn', value: 'Моё имя', inline: false },
                { name: 'Тег: #2439', value: 'Мой тег', inline: false },
